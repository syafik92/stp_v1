									...
									<table id="example1" class="table table-bordered table-hover">
										...
										<tbody>
											<%
												int x = 1;
											%>
											<c:forEach items="${unitBahagian}" var="pesawat">

												<tr>
													<td><%=x%></td>
													<td>${pesawat.unitBahagianDesc}</td>
													<td>
														<button type="button" class="btn btn-info btn-block "
															data-toggle="modal"
															data-target="#modal-pengesahan${pesawat.unitBahagianiId}">Kemaskini</button>
																...
																<div class="modal-content">
																	...
																	<div class="modal-body">
																		<form:form method="POST"
																			modelAttribute="kemaskiniUnit"
																			action="${contextPath}/updateUnit"
																				...
																				<div class="form-group">
																					<div class="col-sm-12">
																						...
																						<div class="col-sm-6">
																							<spring:bind path="unitBahagianDesc">
																								<form:input type="text" class="form-control"
																									id="unitBahagianDesc" path="unitBahagianDesc"></form:input>
																							</spring:bind>
																						</div>
																					</div>
																				</div>
