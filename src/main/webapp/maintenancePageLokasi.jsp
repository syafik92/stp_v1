									...
									<table id="example1" class="table table-bordered table-hover">
										...
										<tbody>
											<%
												int x = 1;
											%>
											<c:forEach items="${refLokasi}" var="lokasi">
																...
																<div class="modal-content">
																	...
																	<div class="modal-body">
																		<form:form method="POST"
																			modelAttribute="kemaskiniLokasi"
																			action="${contextPath}/updateLokasi"
																			class="form-horizontal">
																			<div class="box-body">
																				<div class="form-group">
																					<div class="col-sm-12">
																						<spring:bind path="lokasiId">
																							<form:input type="hidden" class="form-control"
																								path="lokasiId" value="${lokasi.lokasiId}"></form:input>
																						</spring:bind>
