									...
									<table id="example1" class="table table-bordered table-hover">
										...
										<tbody>
											<%
												int x = 1;
											%>
											<c:forEach items="${refPeruntukan}" var="peruntukan">

												<tr>
													<td><%=x%></td>
													<td>${peruntukan.peruntukanDesc}</td>
													<td>
																...
																<div class="modal-content">
																	...
																	<div class="modal-body">
																		<form:form method="POST"
																			modelAttribute="kemaskiniPeruntukan"
																			action="${contextPath}/updatePeruntukan"
																			class="form-horizontal">
																			<div class="box-body">
																				<div class="form-group">
																					<div class="col-sm-12">
																						<spring:bind path="peruntukanId">
																							<form:input type="hidden" class="form-control"
																								path="peruntukanId"
																								value="${peruntukan.peruntukanId}"></form:input>
																						</spring:bind>
